...
CREATE TABLE `imagen` (
  `id_apunte` int NOT NULL,
  `numero_imagen` int NOT NULL,
  `archivo_imagen` varchar(45) NOT NULL,
  PRIMARY KEY (`numero_imagen`,`id_apunte`),
  KEY `CF_APUNTE_IMAGEN` (`id_apunte`),
  CONSTRAINT `CF_APUNTE_IMAGEN` FOREIGN KEY (`id_apunte`) REFERENCES `apunte` (`id_apunte`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-24 19:45:37
